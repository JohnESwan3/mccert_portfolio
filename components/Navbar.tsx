...
export default function Navbar() {
  ...
  return (
    <div className="sticky top-0 z-50">
      <nav className="bg-slate-50 shadow-md" id="nav">
          ...
          <div className="flex h-16 items-center justify-between">
            ...
            <div className="-mr-2 flex md:hidden">
              <button
                ...
                type="button"
                className="inline-flex items-center justify-center rounded-md bg-slate-50 p-2 text-cyan-500 shadow-inner transition-all hover:bg-cyan-700 hover:text-slate-100 focus:outline-none"
