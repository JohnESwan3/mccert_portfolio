      ...
      <div className="mx-auto px-4 pt-16 sm:max-w-xl md:max-w-full md:px-24 lg:max-w-screen-xl lg:px-8">
        <div className="row-gap-10 mb-8 grid lg:grid-cols-6">
          <div className="row-gap-8 grid grid-cols-2 gap-5 md:grid-cols-4 lg:col-span-4">
            <div>
              <p className="footer-main">Navigation</p>
            ...
            <div>
              <p className="footer-main">Projects</p>
              <ul className="mt-2 space-y-2">
                <li>
                  <Link href="https://www.stockpilegaming.com">
                    <a className="footer-secondary">Stockpile Gaming</a>
                  </Link>
                </li>
                <li>
                  <Link href="https://www.johneswan3.com">
                    <a className="footer-secondary">Web Dev Portfolio</a>
                  </Link>
                </li>
              </ul>
            </div>
        ...
        <div className="flex flex-col justify-between border-t border-slate-500 pt-5 pb-10 sm:flex-row">
